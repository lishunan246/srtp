...
<div ng-controller="panelController" class="container" id="left-part">
    ...
    <script type="text/ng-template" id="uploadModal.html">
        <div class="modal-header">
            <h3 class="modal-title">上传开题报告</h3>
        </div>
    ...
    <script type="text/ng-template" id="bylwuploadModal.html">
        <div class="modal-header">
            <h3 class="modal-title">上传毕业论文</h3>
        </div>
        <div class="modal-body">
            <form>
                <div class="form-group">
                ...
                <button ng-click="uploadFile('/bylwupload.do')" class="button btn-default">上传</button>
            </form>
        </div>
        <%--<div class="modal-footer">--%>
        <%--<button class="btn btn-primary" type="button" ng-click="ok()">OK</button>--%>
    ...
    <div class="panel  panel-success">
        ...
        <table class="table text-center">
            <tr>
                <td ng-click="open('ktbg')"><a>上传</a></td>
    ...
    <div class="panel  panel-primary">
        ...
        <table class="table text-center">
            <tr>
                <td ng-click="open('bylw')"><a>上传</a></td>
